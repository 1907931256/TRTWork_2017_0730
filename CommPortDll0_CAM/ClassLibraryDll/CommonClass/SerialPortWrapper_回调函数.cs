   ...
   public class ReportEventArgs : EventArgs
    ...
    class SerialPortWrapper
    {
        ...
        public void SendRecv(byte[] req, out byte[] resp)
        {
            ...
            Console.WriteLine("SerialPortWrapper send data = " + ByteArrayToHexString(req));
            ...
            Console.WriteLine("SerialPortWrapper recv data = " + ByteArrayToHexString(resp));
            sendId_ = 0;
            Thread.Sleep(10);
            sendEvent_.Set();
        }
        ...
        private void DataReceivedHandler(Object sender, SerialDataReceivedEventArgs e)
        {
            ...
            Console.WriteLine("DataReceivedHandler data = " + ByteArrayToHexString(readBuffer_, 0, readBytes));
