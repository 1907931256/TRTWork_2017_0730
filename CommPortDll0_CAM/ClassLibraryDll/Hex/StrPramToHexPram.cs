            ...
            if (Common.Model == "MMI")
            {
                switch (pram)
                {
                    ...
                    case "2站电机电源": hexPram = "72 05 12 04 03 81";
                        break;
                    case "2站报警报警": hexPram = "72 05 12 05 01 00 81";
                        break;
                    ...
                    case "5站耳机拔出": hexPram = "72 05 15 02 07 FF 81";
                        break;
                    case "5站报警报警": hexPram = "72 05 15 05 01 00 81";
                        break;
                    ...
                    case "6站复位": hexPram = "72 04 16 5a 00 81";
                        break;
            ...
            else if (Common.Model == "CAM")
            {
                switch (pram)
                {
                    ...
                    case "1站取放1下压检测": hexPram = "72 05 C1 01 06 FF 81";
                        break;//1站前到位检测
                    case "1站前到位检测": hexPram = "72 05 C1 01 07 FF 81";
                        break;
                    ...
                    case "1站取放2下压检测": hexPram = "72 05 C1 01 09 FF 81";
                        break;
                    case "1站后到位检测": hexPram = "72 05 C1 01 0a FF 81";
                        break;

                    case "1站警告取消检测": hexPram = "72 05 C1 01 0b FF 81";
                        break;
                    case "1站前门打开检测": hexPram = "72 05 C1 01 0c FF 81";
                        break;
                    #endregion
                    ...
                    case "1站取放1下压": hexPram = "72 05 C1 02 04 00 81";
                        break;
                    case "1站取放1吸取": hexPram = "72 05 C1 02 05 00 81";
                        break;
                    case "1站取放1松开": hexPram = "72 05 C1 02 05 FF 81";
                        break;
                    case "1站取放2抬起": hexPram = "72 05 C1 02 06 FF 81";
                        break;
                    case "1站取放2下压": hexPram = "72 05 C1 02 06 00 81";
                        break;
                    case "1站取放2吸取": hexPram = "72 05 C1 02 07 00 81";
                        break;
                    case "1站取放2松开": hexPram = "72 05 C1 02 07 FF 81";
                        break;
                    case "1站前门关闭": hexPram = "72 05 C1 02 08 FF 81";
                        break;
                    case "1站前门打开": hexPram = "72 05 C1 02 08 00 81";
                        break;
                    #endregion
                    ...
                    case "1站状态灯黄灯": hexPram = "72 05 C1 04 01 AA 81";
                        break;
                    case "1站电机回零点": hexPram = "72 05 C1 04 04 00 81";
                        break;
                    case "1站电机左运动": hexPram = "72 05 C1 04 03 00 81";
                        break;
                    case "1站电机中运动": hexPram = "72 05 C1 04 03 AA 81";
                        break;
                    case "1站电机右运动": hexPram = "72 05 C1 04 03 FF 81";
                        break;

                    case "1站复位": hexPram = "72 04 C1 5A FF 81";
                        break;
                    #endregion
                    #endregion
                    ...
                    case "2站产品到位检测": hexPram = "72 05 C2 01 01 FF 81";
                        break;
                    case "2站标靶上到位检测": hexPram = "72 05 C2 01 02 FF 81";
                        break;
                    case "2站标靶下到位检测": hexPram = "72 05 C2 01 03 FF 81";
                        break;
                    case "2站解析远离检测": hexPram = "72 05 C2 01 04 FF 81";
                        break;
                    case "2站色卡远离检测": hexPram = "72 05 C2 01 05 FF 81";
                        break;
                    case "2站警告取消检测": hexPram = "72 05 C2 01 06 FF 81";
                        break;
                    case "2站增距远离检测": hexPram = "72 05 C2 01 07 FF 81";
                        break;
                    case "2站后白远离检测": hexPram = "72 05 C2 01 08 FF 81";
                        break;
                    #endregion
                    ...
                    case "2站手机松开": hexPram = "72 05 C2 02 01 FF 81";
                        break;
                    case "2站标靶靠近": hexPram = "72 05 C2 02 02 00 81";
                        break;
                    case "2站标靶远离": hexPram = "72 05 C2 02 02 FF 81";
                        break;
                    case "2站副摄靠近": hexPram = "72 05 C2 02 03 00 81";
                        break;
                    case "2站副摄远离": hexPram = "72 05 C2 02 03 FF 81";
                        break;
                    case "2站前后靠近": hexPram = "72 05 C2 02 04 00 81";
                        break;
                    case "2站前后远离": hexPram = "72 05 C2 02 04 FF 81";
                        break;
                    case "2站增距靠近": hexPram = "72 05 C2 02 05 00 81";
                        break;
                    case "2站增距远离": hexPram = "72 05 C2 02 05 FF 81";
                        break;
                    case "2站解析靠近": hexPram = "72 05 C2 02 06 00 81";
                        break;
                    case "2站解析远离": hexPram = "72 05 C2 02 06 FF 81";
                        break;
                    case "2站色卡靠近": hexPram = "72 05 C2 02 07 00 81";
                        break;
                    case "2站色卡远离": hexPram = "72 05 C2 02 07 FF 81";
                        break;
                    case "2站状态警告": hexPram = "72 05 C2 02 08 00 81";
                        break;
                    case "2站状态正常": hexPram = "72 05 C2 02 08 FF 81";
                        break;
                    case "2站后白靠近": hexPram = "72 05 C2 02 09 00 81";
                        break;
                    case "2站后白远离": hexPram = "72 05 C2 02 09 FF 81";
                        break;
                    #endregion

                    #region 03模块  光源调节
                    case "2站后色光源调节": hexPram = "72 07 C2 03 01";
                        break;
                    case "2站后白光源调节": hexPram = "72 05 C2 03 02";
                        break;
                    #endregion
                    ...
                    case "2站复位": hexPram = "72 04 C2 0F 00 81";
                        break;
                    #endregion
                    #endregion
                    ...
                    case "3站解析远离检测": hexPram = "72 05 C3 01 03 FF 81";
                        break;
                    case "3站右取放检测": hexPram = "72 05 C3 01 04 FF 81";
                        break;
                    ...
                    case "3站警告取消检测": hexPram = "72 05 C3 01 0a FF 81";
                        break;
                    case "3站取放门打开检测": hexPram = "72 05 C3 01 0b FF 81";
                        break;
                    case "3站产品抬起检测": hexPram = "72 05 C3 01 0c FF 81";
                        break;
                    ...
                    case "3站后白远离": hexPram = "72 05 C3 02 03 FF 81";
                        break;
                    case "3站暗室打开": hexPram = "72 05 C3 02 04 00 81";
                        break;
                    case "3站暗室关闭": hexPram = "72 05 C3 02 04 FF 81";
                        break;
                    case "3站取放3抬起": hexPram = "72 05 C3 02 05 00 81";
                        break;
                    case "3站取放3下压": hexPram = "72 05 C3 02 05 FF 81";
                        break;
                    case "3站取放3吸取": hexPram = "72 05 C3 02 06 00 81";
                        break;
                    case "3站取放3松开": hexPram = "72 05 C3 02 06 FF 81";
                        break;
                    case "3站状态警告": hexPram = "72 05 C3 02 07 00 81";
                        break;
                    case "3站状态正常": hexPram = "72 05 C3 02 07 FF 81";
                        break;

                    case "3站取放门关闭": hexPram = "72 05 C3 02 08 FF 81";
                        break;
                    case "3站取放门打开": hexPram = "72 05 C3 02 08 00 81";
                        break;
                    case "3站产品放下": hexPram = "72 05 C3 02 09 FF 81";
                        break;
                    case "3站产品抬起": hexPram = "72 05 C3 02 09 00 81";
                        break;
                    case "3站解析靠近": hexPram = "72 05 C3 02 0A 00 81";
                        break;
                    case "3站解析远离": hexPram = "72 05 C3 02 0A FF 81";
                        break;
                    ...
                    #region 03模块  光源调节
                    case "3站前色光源调节": hexPram = "72 07 C3 03 01";
                        break;
                    case "3站前白光源调节": hexPram = "72 05 C3 03 02";
                        break;
                    case "3站后白光源调节": hexPram = "72 05 C3 03 03";
                        break;
                    case "3站近焦光源调节": hexPram = "72 05 C3 03 04";
                        break;
                    #endregion
                    ...
                    case "3站状态灯黄灯": hexPram = "72 05 C3 04 01 AA 81";
                        break;
                    case "3站电机取": hexPram = "72 07 C3 04 02 00";
                        break;
                    case "3站电机": hexPram = "72 07 C3 04 02 AA";
                        break;
                    case "3站电机放": hexPram = "72 07 C3 04 02 FF";
                        break;
                    case "3站电机回零点": hexPram = "72 05 C3 04 03 00 81";
                        break;

                    case "3站复位": hexPram = "72 04 C3 0F 00 81";
                        break;
